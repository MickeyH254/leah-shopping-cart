            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                        ...
                        @foreach(Cart::content() as $pdt)
                            <tr class="cart_item">
                                ...
                                <td class="product-price">
                                    <h5 class="price amount">Ksh {{ $pdt->price }}</h5>
                                </td>
                                <td class="product-quantity">
                                    <div class="quantity">
                                        <a href="{{ route('cart.red', ['id' => $pdt->rowId, 'qty' => $pdt->qty] ) }}" class="quantity-minus">-</a>
                                ...
                                <td class="product-subtotal">
                                    <h5 class="total amount">Ksh {{ $pdt->total() }}</h5>
                                </td>
                    ...
                    <div class="cart-total">
                        ...
                        <h5 class="cart-total-total">Total: <span class="price">Ksh {{ Cart::total() }}</span></h5>
