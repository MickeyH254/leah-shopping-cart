<!DOCTYPE html>
    ...
    <head>
        ...
        -->
        <link href="{{ asset("/adminlte/css/skins/skin-red.min.css")}}" rel="stylesheet" type="text/css" />
    ...
    <div class="wrapper">
        ...
        <header class="main-header">
            ...
            <!-- Logo -->
            <a href="index2.html" class="logo"><b>System</b>Admin</a>
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown user user-menu">
                            ...
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                ...
                                <img src="{{ asset('adminlte/img/avatar.png') }}" class="user-image" alt="User Image"/>
        ...
        <aside class="main-sidebar">
            ...
            <section class="sidebar">
                ...
                <ul class="sidebar-menu">
                    ...
                    <li class="treeview">
                        <a href="#"><span>Ecommerce</span> <i class="fa fa-angle-left pull-right"></i></a>
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <h1>
                   Karanja Food Services
                    <small>It tastes nice.</small>
                </h1>
                <ol class="breadcrumb">
