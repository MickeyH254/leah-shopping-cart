					...
					<table class="shop_table cart">
                        ...
                        <tr class="cart_item">
                            ...
                            <td class="product-subtotal">
                                <h5 class="total amount">Ksh {{ $item->total() }}</h5>
                            </td>
						...
						<tr class="cart_item total">
							...
							<td class="product-subtotal">
								<h5 class="total amount">Ksh{{ Cart::total() }}</h5>
							</td>
						</tr>
						...
						<div class="logos">
                            ...
                            <form action="{{ route('cart.checkout') }}" method="POST">
                                ...
                                <script
                                    ...
                                    data-key="pk_test_GArravI8GogYw5rJBUtGug7S"
                                    data-amount="{{ Cart::total()  }}"* 100
                                    data-name="Infinity Food"
                                    data-description="Your charge"
